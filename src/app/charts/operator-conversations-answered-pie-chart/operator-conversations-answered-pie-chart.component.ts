...
@Component({
  selector: 'app-operator-conversations-answered-pie-chart',
  templateUrl: '../chart-template.html',
  styleUrls: ['./operator-conversations-answered-pie-chart.component.css']
})
export class OperatorConversationsAnsweredPieChartComponent extends ChartComponent implements OnInit {
